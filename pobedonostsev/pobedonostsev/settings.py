"""
Django settings for pobedonostsev project.
...
SECRET_KEY = 'django-insecure-xd+y*tmnbi@jb@0lj(d377e^4$sw+78p#=h6ctg3lm0$xfh8^)'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['pobedonostsev.msk.ru']
...
INSTALLED_APPS = [
    ...
    'django_unicorn',
    'LawmakersMapApp.apps.LawmakersmapappConfig',
]
...
ROOT_URLCONF = 'pobedonostsev.urls'
...
WSGI_APPLICATION = 'pobedonostsev.wsgi.application'
